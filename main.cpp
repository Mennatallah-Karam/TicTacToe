...
int main(int argc, char *argv[]) {
    ...
    qDebug() << "Application initialization took :" << initTime << "nanoseconds";

GameManager gameManager;
   QSqlDatabase db = QSqlDatabase::addDatabase("QSQLITE");
    db.setDatabaseName("C:/Users/Meena/OneDrive/Documents/Mydatabase/database.db");
    ...
    MainWindow w;
    w.show();
    qint64 mainWindowTime = timer.nsecsElapsed();
    qDebug() << "MainWindow creation and show took :" << mainWindowTime << "nanoseconds";
return app.exec();
}
